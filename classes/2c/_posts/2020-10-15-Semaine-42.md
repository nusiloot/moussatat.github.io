...
{: .box-error} 
*Mises à jour   
	- 28/11 ajout d'un lien choix de spécialités de terminale et cpge  
	- 20/11 ajout d'un lien de présentation de la spécialité SVT* 
...
### Choix de spécialités et classes préparatoires scientifiques

Les classes prépratoires comptent 4 filières (MPSI, PCSI, PTSI et MPI) qui mênent aux mêmes écoles en général, et la filière BCPST (préprare aux écoles d'agronomie et écoles vétérinaires). 
Ce [Lien](https://prepas.org/?rubrique=32) présente les choix de spécialités conseillés en Terminale pour chaque parcours.
...
### À venir
Le contenu d'autres modules ne sera accessible que dans les semaines à venir. J'espère que le contenu sera à jour pour correspondre à la réforme du Bac 2021. Quelques exemples :
- [Cap sur les métiers de la **chimie** de demain](https://www.fun-mooc.fr/courses/course-v1:CNAM+01055+session02/about), *à partir du 12 octobre*.
- [Mon métier de la **santé**](https://www.fun-mooc.fr/courses/course-v1:Uness+181001+session01/about) *à partir du 23 novembre*, avec présentation des métiers de la médecine, du paramédicale et de la pharmacie.
- [De la Prépa aux Grandes **Ecoles de Commerce** : le bon parcours pour moi?](https://www.fun-mooc.fr/courses/course-v1:cpge-economiques+153001+session03/about) *à partir du 23 novembre*.
- [Les métiers du **numérique** pour inventer le monde de demain](https://www.fun-mooc.fr/courses/course-v1:lorraine+30012+session01/about) *à partir du 23 novembre*, présente les métiers liés à l'**informatique** (développeur, administrateur réseaux, analyse de données) mais aussi à la **communication et aux médias** (chef de publicité, responsable communication, community manager).
